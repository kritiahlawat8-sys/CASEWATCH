      ...
      <section id="overview" className="overview-section" aria-label="CaseWatch Overview">
        <div className="overview-inner">
          ...
          <header ref={headerRef} className="overview-header js-fade-in-up">
            <div className="flex flex-row items-center justify-between gap-4 md:gap-12 w-full">
              ...
              <div className="flex w-2/5 lg:w-1/3 justify-center items-center opacity-80" aria-hidden="true">
                <img src="/ashoka.png" alt="Ashoka Stambh" className="w-full max-w-[240px] md:w-[280px] lg:w-[350px] h-auto object-contain mix-blend-multiply scale-[1.2] md:scale-[1.35] translate-x-0 md:translate-x-[140px] lg:translate-x-[250px]" />
              </div>
            </div>
          </header>
