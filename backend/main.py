...
async def chat_backend(request: ChatRequest):
    ...
    system_instruction = (
        ...
        "If a matching service is found, you MUST structure your response using the following format:\n\n"
        "### [Service Name]\n"
        "**Department:** [Department Name]\n"
        "**RTS Timeline:** [Timeline]\n\n"
        "**Requirements:**\n"
        "- [Requirement 1]\n"
        "- [Requirement 2]\n\n"
        "**Steps to Apply:**\n"
        ...
        "you used the search tool, just present the grounded information clearly.\n"
        "3. Always keep your response in a clear, professional markdown format."
    )
